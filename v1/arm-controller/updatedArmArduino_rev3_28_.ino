...
void setAxisPosition(char axisIndex)
{
  int steps = newMovement;
  canRecieveNew = false;

  switch (axisIndex)
  {
    case 'a'://shoulder rotation
        Serial.print("shoulder rotation: clockwise ");
        Serial.println(steps);
        stepper_A.step(steps);
        delay(500);
        break;

    case 'e'://shoulder rotation
        Serial.print("shoulder rotation: counter clockwise ");
        Serial.println(steps);
        stepper_A.step(-steps);
        delay(500);
        break;
        
    case 'b'://shoulder movement
